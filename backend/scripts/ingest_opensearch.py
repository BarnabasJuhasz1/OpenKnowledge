...
The production loader is deploy/opensearch-ingest/scripts/ingest_opensearch.py; the two
differ only in the OpenSearch client block below — keep the resume logic identical.
